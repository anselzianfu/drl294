...
class ModelBasedPolicy(object):
    ...
    def _dynamics_func(self, state, action, reuse):
        ...
        delta_norm = utils.build_mlp(input_layer=sa_norm, output_dim=self._state_dim, scope="dyfunc",
    ...
    def _setup_training(self, state_ph, next_state_ph, next_state_pred):
        ...
        deltas_norm = utils.normalize(deltas, self._init_dataset.state_mean, self._init_dataset.state_std)
    ...
    def _setup_action_selection(self, state_ph):
        ...
        actions_matirx = tf.random_uniform(minval=self._action_space_low, maxval=self._action_space_high,
